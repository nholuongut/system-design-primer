...
你正在尋找資源來面對[**程式語言面試**](https://github.com/nholuongut/interactive-coding-challenges)嗎？
...
請參考 [**互動程式語言學習挑戰**](https://github.com/nholuongut/interactive-coding-challenges)，當中還包含了底下的學習單字卡：

* [程式語言學習單卡](https://github.com/nholuongut/interactive-coding-challenges/tree/master/anki_cards/Coding.apkg)
...
* 改善章節內容
* 增加新的章節
* [翻譯](https://github.com/nholuongut/system-design-primer/issues/28)
