...
For bug reports or requests [submit an issue](https://github.com/nholuongut/system-design-primer/issues).

## Pull Requests

The preferred way to contribute is to fork the
[main repository](https://github.com/nholuongut/system-design-primer) on GitHub.

1. Fork the [main repository](https://github.com/nholuongut/system-design-primer).  Click on the 'Fork' button near the top of the page.  This creates a copy of the code under your account on the GitHub server.
